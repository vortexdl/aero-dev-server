...
(self["webpackChunkaero_sandbox"] =
	...
	["src_sandboxers_HTML_adaptors_useMutationObservers_ts"],
	{
		"./src/sandboxers/HTML/adaptors/useMutationObservers.ts": function (
			...
			new MutationObserver(function (mutations) {
				...
				try {
					for (
						var _iterator = mutations[Symbol.iterator](), _step;
							...
							try {
								for (
									var _iterator1 =
										...
										_step1;
									!(_iteratorNormalCompletion2 = (_step1 =
...
//# sourceMappingURL=src_sandboxers_HTML_adaptors_useMutationObservers_ts.js.map

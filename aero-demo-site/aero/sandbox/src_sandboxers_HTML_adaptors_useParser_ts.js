...
(self["webpackChunkaero_sandbox"] =
	...
	["src_sandboxers_HTML_adaptors_useParser_ts"],
	{
		"./src/sandboxers/HTML/adaptors/useParser.ts": function (
			...
			Object(
				(function webpackMissingModule() {
					var e = new Error("Cannot find module 'htmlparser2'");
					e.code = "MODULE_NOT_FOUND";
					throw e;
				})()
			);
			/* harmony import */ var _shared_rewriteElement__WEBPACK_IMPORTED_MODULE_1__ =
				__webpack_require__(
					/*! ../shared/rewriteElement */ "./src/sandboxers/HTML/shared/rewriteElement.ts"
				);
				...
				try {
					for (
						...
						if (childNode.type === "tag") {
							...
							// @ts-ignore
							(0,
							_shared_rewriteElement__WEBPACK_IMPORTED_MODULE_1__[
								"default"
							])(childNode);
						}
					}
...
//# sourceMappingURL=src_sandboxers_HTML_adaptors_useParser_ts.js.map
